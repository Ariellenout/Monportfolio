...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-24 sm:py-32 bg-dark flex flex-col items-center justify-center px-6 overflow-hidden border-t border-ink/10 selection:bg-accent-copper selection:text-white">
      ...
      <div className="w-full max-w-5xl mx-auto flex flex-col items-center text-center relative z-10" ref={ref}>
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-serif font-light tracking-tight text-ink leading-tight hover:italic transition-all duration-700 cursor-none">
        ...
        >
          <div className="flex flex-col items-center gap-2">
            <span className="text-lg sm:text-xl md:text-2xl font-serif font-light italic text-transparent transition-all duration-700 group-hover:text-ink/80" style={{ WebkitTextStroke: '0.5px rgba(18, 23, 21, 0.5)' }}>
              {email}
            </span>
