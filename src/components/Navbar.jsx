    ...
    <>
      ...
      >
        <div className={`
          ...
          ${scrolled
            ? 'bg-white/70 backdrop-blur-xl border-ink/10 shadow-[0_8px_32px_rgba(18,23,21,0.12)]'
        ...
        `}>
          ...
          >
            <div className="w-1.5 h-1.5 rounded-full bg-accent-copper group-hover:shadow-[0_0_10px_rgba(67,139,157,0.8)] transition-shadow duration-500" />
          ...
          >
            <motion.div
              className={`h-[1px] bg-ink transition-all duration-300 ${isOpen ? 'w-full rotate-45 translate-y-[3px]' : 'w-full group-hover:bg-accent-copper'}`}
            />
            <motion.div
              className={`h-[1px] bg-ink transition-all duration-300 ${isOpen ? 'w-full -rotate-45 -translate-y-[3px]' : 'w-2/3 group-hover:w-full group-hover:bg-accent-copper'}`}
            />
          </button>
        </div>
      </motion.header>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="fixed inset-0 z-[90] bg-white/95 backdrop-blur-2xl flex flex-col justify-center px-8 sm:px-16"
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80vw] h-[80vw] bg-[radial-gradient(circle,rgba(67,139,157,0.1)_0%,transparent_60%)] pointer-events-none" />
